...
// CHỈ lấy các danh mục con có danh mục cha là Điện thoại (parent_id = 1)
$sql_brands = "SELECT * FROM categories WHERE parent_id = 1 ORDER BY id ASC";
$res_brands = mysqli_query($conn, $sql_brands);

$brands = [];
$allowed_cat_ids = [1]; // Đưa sẵn ID 1 vào mảng phòng trường hợp có sp gắn thẳng vào thẻ cha
